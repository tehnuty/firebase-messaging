...
def send_notification(send_to_all=False, push_token=None, push_topic=None, title=None, body=None, url=None, action=None, card_id=None, device_id=None, silent=False):
    """
    :param send_to_all: optional, if send to all, set to True
    ...
    :param card_id: notification ID (if you want to override notification) e.g. afs:Card:001
    ...
    if send_to_all:
        ...
        message = messaging.Message(
            ...
            apns=apns_config,
            condition="'%s' in topics && '%s' in topics" % (push_topic, "environment-or-app-id"),
        )
